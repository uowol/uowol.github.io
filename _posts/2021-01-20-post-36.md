...
- $\frac{d}{dx} [\cos x] = - \sin x$
    - sin과 cos의 그래프를 그려보면 아래와 같습니다.<br>
    ![그림3](/assets/imgs/post_36/그림3.png)<br>
    - $\sin x$를 미분하면 $\cos x$, 즉, $\sin x$ 그래프를 왼쪽으로 $\frac{\pi}{2}$ 만큼 이동한 것과 같은 결과가 나옵니다.<br>
    ![그림4](/assets/imgs/post_36/그림4.png)<br>
...
$e^n$은 도함수가 그 자체인 유일한 함수입니다. <small>~~(f(x)=0는 마음 속 깊이 묻어두도록 하죠.)~~</small>
...
![그림5](/assets/imgs/post_36/그림5.png)<br>
<small>그림 출처: 칸 아카데미</small>
{:style="text-align:center;"}
