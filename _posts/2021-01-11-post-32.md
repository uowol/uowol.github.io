...
![그림2](/assets/imgs/post_32/example1.png)
{: style="text-align:center"}
...
이와 같이 학습을 진행한다면, 함정이나 빈 칸은 $\max_aQ(s_{t+1}, a)$에 별다른 영향을 미치지 못하기 때문에 도착지(Reward=+1)의 방향으로 학습이 진행될 것 입니다.

학습이 정상적으로 진행되었을 때 각 칸의 Q-value는 아래 그림과 같습니다.

![그림3](/assets/imgs/post_32/example2.jpg)
{: style="text-align:center"}
...
### 결과 확인하기
위의 [예제][example]를 통해 학습 결과를 확인하실 수 있습니다.



[man]: https://mangkyu.tistory.com/61?category=767742
[example]: #canvas_background
